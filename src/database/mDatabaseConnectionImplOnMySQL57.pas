...
unit mDatabaseConnectionImplOnMySQL57;
...
type
  ...
  TTMySQL57DatabaseCommandImpl = class (TAbstractSqldbDatabaseCommandImpl);
...
initialization
  ...
  GetDataConnectionClassesRegister.RegisterImplementations(TMySQL57DatabaseConnectionImpl.GetImplementationName, dvMySQL57, TMySQL57DatabaseConnectionImpl, TMySQL57DatabaseQueryImpl, TTMySQL57DatabaseCommandImpl);
